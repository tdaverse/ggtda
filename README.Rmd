...
We can visualize the persistence data using a barcode (left) and a flat persistence diagram (right). In the barcode plot, the dashed line indicates the cutoff at the proximity `prox` (= `r prox`); in the persistence diagram plot, the diamond point marks this cutoff.
