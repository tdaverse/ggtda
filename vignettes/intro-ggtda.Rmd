...
vignette: >
  %\VignetteIndexEntry{Introduction to the ggtda package}
...
# create topological barcode with geom layer and appropriate theme
ggplot(annulus.phom, aes(start = birth, end = death, group = dimension)) +
  geom_barcode() +
