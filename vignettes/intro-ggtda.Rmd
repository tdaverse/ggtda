---
title: "Plotting persistent homology with ggtda"
...
We will calculate its persistent homology using the TDAstats package (following code block) and then plot the result with each of the three visualizations using ggtda.
