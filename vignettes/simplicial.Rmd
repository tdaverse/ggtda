...
Note that the two stats are parameterized differently; thus, correct values must be provided with care.
The reason behind this is that the radius is more intuitive to understand `stat_disk`, but topological barcodes and persistence diagrams are generally plotted with the diameter on the relevant axes.
...
*ADD NOTE ABOUT CECH AND V-R COMPLEX HERE; show difference with equilateral triangle*
